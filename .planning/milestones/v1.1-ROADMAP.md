...
- [x] **Phase 5: Constraints & Manual Mode** -- Constraint types (ASAP/MSO/SNET/FNLT) and per-task manual scheduling toggle (completed 2026-02-17)
- [x] **Phase 6: Progress Tracking** -- Percent complete, actual dates, frozen completed tasks, Gantt progress bars (completed 2026-02-17)
...
Plans:
- [x] 05-01-PLAN.md -- Types, DB migration, and CPM engine constraint/manual logic (TDD)
- [x] 05-02-PLAN.md -- Service/hook wiring, constraint violation toasts, TaskForm UI
- [x] 05-03-PLAN.md -- Gantt visual indicators and end-to-end verification
- [x] 05-04-PLAN.md -- Gap closure: fix constraint persistence (database types) and modal UX
...
Plans:
- [x] 06-01-PLAN.md -- Database migration, type extensions, and TDD bidirectional percent/status sync function
- [x] 06-02-PLAN.md -- Scheduling engine frozen/in-progress task handling and batch persist
- [x] 06-03-PLAN.md -- UI controls (percent slider, sidebar progress), Gantt progress bar overlay
...
| 5. Constraints & Manual Mode | v1.1 | 4/4 | Complete | 2026-02-17 |
| 6. Progress Tracking | v1.1 | 3/3 | Complete | 2026-02-17 |
